...
// Index values must be offset to account for negative ranges
char *id24_sprnames[] = {
  "BSH1", "BSH2", "BSHE", "CBR2", "CHR1", "CSPI", "CYB2", "FLMF", "FLMG",
  "GBAL", "GHUL", "GOR6", "GOR7", "GOR8", "GORA", "HBB2", "HBBQ", "HDB7",
  "HDB8", "HETB", "HETC", "HETF", "HETG", "IFLM", "LAMP", "PHED", "POB6",
  "POL7", "POLA", "PPOS", "STC1", "STC2", "STC3", "STG1", "STG2", "STG3",
  "STMI", "TLP6", "VASS", "VFLM", "INCN", "CBLD", "FCPU", "FTNK", NULL,
};
...
// Must account for negative indexes when loading
// TODO: cleanup magic numbers with proper semantic types and additional enums
state_t id24_states[NUMSTATES_ID24] =
{
  { SPR_POL7, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_HBBQ, 0|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048190, },
  { SPR_HBBQ, 1|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048189, },
  { SPR_HBBQ, 2|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048191, },
  { SPR_HBB2, 0|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048187, },
  { SPR_HBB2, 1|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048188, },
  { SPR_HBB2, 2|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048188, },
  { SPR_GOR6, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_GOR7, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_GOR8, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_GORA, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_HDB7, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_HDB8, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_POLA, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_POB6, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_SMT2, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_BSH1, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_BSH1, 1,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_BSH1, 2,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_BSH2, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_BSH2, 1,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_BSH2, 2,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STMI, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STG1, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STG2, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STG3, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STC1, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STC2, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_STC3, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_CHR1, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_LAMP, 0|FF_FULLBRIGHT,  -1,  { .v = NULL                 }, S_NULL, },
  { SPR_LAMP, 1|FF_FULLBRIGHT,  3,   { .p1 = A_Scream            }, -1879048160, },
  { SPR_LAMP, 1|FF_FULLBRIGHT,  3,   { .p1 = A_Fall              }, -1879048159, },
  { SPR_LAMP, 2|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048158, },
  { SPR_LAMP, 3|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048159, },
  { SPR_TLP6, 0|FF_FULLBRIGHT,  -1,  { .v = NULL                 }, S_NULL, },
  { SPR_CBR2, 0|FF_FULLBRIGHT,  -1,  { .v = NULL                 }, S_NULL, },
  { SPR_TNT1, 0,                1,   { .p1 = A_Look              }, -1879048155, },
  { SPR_TNT1, 0,                35,  { .p1 = A_PlaySound         }, -1879048154, -1879048168, },
  { SPR_TNT1, 0,                250, { .p1 = A_PlaySound         }, S_NULL, .misc1 = -1879048182, .misc2 = true, },
  { SPR_TNT1, 0,                139, { .p1 = A_PlaySound         }, -1879048152, -1879048183, },
  { SPR_TNT1, 0,                105, { .p1 = A_PlaySound         }, S_NULL, .misc1 = -1879048184, .misc2 = true, },
  { SPR_GHUL, 0,                10,  { .p1 = A_Look              }, -1879048149, },
  { SPR_GHUL, 1,                10,  { .p1 = A_Look              }, -1879048150, },
  { SPR_GHUL, 0,                3,   { .p1 = A_Chase             }, -1879048147, },
  { SPR_GHUL, 0,                3,   { .p1 = A_Chase             }, -1879048146, },
  { SPR_GHUL, 1,                3,   { .p1 = A_Chase             }, -1879048145, },
  { SPR_GHUL, 1,                3,   { .p1 = A_Chase             }, -1879048144, },
  { SPR_GHUL, 2,                3,   { .p1 = A_Chase             }, -1879048143, },
  { SPR_GHUL, 2,                3,   { .p1 = A_Chase             }, -1879048142, },
  { SPR_GHUL, 1,                3,   { .p1 = A_Chase             }, -1879048141, },
  { SPR_GHUL, 1,                3,   { .p1 = A_Chase             }, -1879048148, },
  { SPR_GHUL, 3|FF_FULLBRIGHT,  4,   { .p1 = A_FaceTarget        }, -1879048139, },
  { SPR_GHUL, 4|FF_FULLBRIGHT,  4,   { .p1 = A_FaceTarget        }, -1879048138, },
  { SPR_GHUL, 5|FF_FULLBRIGHT,  4,   { .p1 = A_MonsterProjectile }, -1879048137, .args = { -1879048180, 0, 0, 0 , -524288 }, },
  { SPR_GHUL, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879048148, },
  { SPR_GHUL, 8|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879048135, },
  { SPR_GHUL, 10|FF_FULLBRIGHT, 3,   { .p1 = A_Pain              }, -1879048148, },
  { SPR_GHUL, 11|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879048133, },
  { SPR_GHUL, 12|FF_FULLBRIGHT, 5,   { .p1 = A_Scream            }, -1879048132, },
  { SPR_GHUL, 13|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879048131, },
  { SPR_GHUL, 14|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879048130, },
  { SPR_GHUL, 15|FF_FULLBRIGHT, 5,   { .p1 = A_Fall              }, -1879048129, },
  { SPR_GHUL, 16|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879048128, },
  { SPR_GHUL, 17|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879048127, },
  { SPR_GHUL, 18,               -1,  { .v = NULL                 }, S_NULL, },
  { SPR_GBAL, 0|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879048125, },
  { SPR_GBAL, 1|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879048126, },
  { SPR_GBAL, 2|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048123, },
  { SPR_APBX, 1|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048122, },
  { SPR_APBX, 2|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048121, },
  { SPR_APBX, 3|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879048120, },
  { SPR_APBX, 4|FF_FULLBRIGHT,  5,   { .v = NULL                 }, S_NULL, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  10,  { .p1 = A_Look              }, -1879048118, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  10,  { .p1 = A_Look              }, -1879048119, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048116, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048115, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048114, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048113, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048112, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048111, },
  { SPR_BSHE, 2|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048110, },
  { SPR_BSHE, 2|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048109, },
  { SPR_BSHE, 2|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048108, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048107, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048106, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048105, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048104, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048103, },
  { SPR_BSHE, 1|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048102, },
  { SPR_BSHE, 2|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048101, },
  { SPR_BSHE, 2|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048100, },
  { SPR_BSHE, 2|FF_FULLBRIGHT,  2,   { .p1 = A_Chase             }, -1879048099, },
  { SPR_BSHE, 0|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879048117, .misc1 = -1879048192, },
  { SPR_BSHE, 3|FF_FULLBRIGHT,  1,   { .p1 = A_RadiusDamage      }, -1879048098, .args = { 100 , 8 } },
  { SPR_BSHE, 3|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879048096, },
  { SPR_BSHE, 3|FF_FULLBRIGHT,  3,   { .p1 = A_Pain              }, -1879048117, },
  { SPR_BSHE, 3|FF_FULLBRIGHT,  4,   { .p1 = A_Scream            }, -1879048094, },
  { SPR_BSHE, 4|FF_FULLBRIGHT,  6,   { .p1 = A_RadiusDamage      }, -1879048093, .args = { 128 , 128 } },
  { SPR_BSHE, 5|FF_FULLBRIGHT,  8,   { .p1 = A_Fall              }, -1879048092, },
  { SPR_BSHE, 6|FF_FULLBRIGHT,  6,   { .v = NULL                 }, -1879048091, },
  { SPR_BSHE, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879048090, },
  { SPR_TNT1, 0,                20,  { .v = NULL                 }, S_NULL, },
  { SPR_CSPI, 0,                10,  { .p1 = A_Look              }, -1879048088, },
  { SPR_CSPI, 1,                10,  { .p1 = A_Look              }, -1879048089, },
  { SPR_CSPI, 0,                20,  { .v = NULL                 }, -1879048086, },
  { SPR_CSPI, 0,                0,   { .p1 = A_PlaySound         }, -1879048085, .misc1 = -1879048185, },
  { SPR_CSPI, 0,                3,   { .p1 = A_Chase             }, -1879048084, },
  { SPR_CSPI, 0,                3,   { .p1 = A_Chase             }, -1879048083, },
  { SPR_CSPI, 1,                3,   { .p1 = A_Chase             }, -1879048082, },
  { SPR_CSPI, 1,                3,   { .p1 = A_Chase             }, -1879048081, },
  { SPR_CSPI, 2,                3,   { .p1 = A_Chase             }, -1879048080, },
  { SPR_CSPI, 2,                3,   { .p1 = A_Chase             }, -1879048079, },
  { SPR_CSPI, 3,                0,   { .p1 = A_PlaySound         }, -1879048078, .misc1 = -1879048185, },
  { SPR_CSPI, 3,                3,   { .p1 = A_Chase             }, -1879048077, },
  { SPR_CSPI, 3,                3,   { .p1 = A_Chase             }, -1879048076, },
  { SPR_CSPI, 4,                3,   { .p1 = A_Chase             }, -1879048075, },
  { SPR_CSPI, 4,                3,   { .p1 = A_Chase             }, -1879048074, },
  { SPR_CSPI, 5,                3,   { .p1 = A_Chase             }, -1879048073, },
  { SPR_CSPI, 5,                3,   { .p1 = A_Chase             }, -1879048086, },
  { SPR_CSPI, 0|FF_FULLBRIGHT,  20,  { .p1 = A_FaceTarget        }, -1879048071, },
  { SPR_CSPI, 6|FF_FULLBRIGHT,  4,   { .p1 = A_SPosAttack        }, -1879048070, },
  { SPR_CSPI, 7|FF_FULLBRIGHT,  4,   { .p1 = A_SPosAttack        }, -1879048069, },
  { SPR_CSPI, 7|FF_FULLBRIGHT,  1,   { .p1 = A_SpidRefire        }, -1879048071, },
  { SPR_CSPI, 8,                3,   { .v = NULL                 }, -1879048067, },
  { SPR_CSPI, 8,                3,   { .p1 = A_Pain              }, -1879048086, },
  { SPR_CSPI, 9,                20,  { .p1 = A_Scream            }, -1879048065, },
  { SPR_CSPI, 10,               7,   { .p1 = A_Fall              }, -1879048064, },
  { SPR_CSPI, 11,               7,   { .v = NULL                 }, -1879048063, },
  { SPR_CSPI, 12,               7,   { .v = NULL                 }, -1879048062, },
  { SPR_CSPI, 13,               7,   { .v = NULL                 }, -1879048061, },
  { SPR_CSPI, 14,               7,   { .v = NULL                 }, -1879048060, },
  { SPR_CSPI, 15,               -1,  { .p1 = A_BossDeath         }, S_NULL, },
  { SPR_CSPI, 15,               5,   { .v = NULL                 }, -1879048058, },
  { SPR_CSPI, 14,               5,   { .v = NULL                 }, -1879048057, },
  { SPR_CSPI, 13,               5,   { .v = NULL                 }, -1879048056, },
  { SPR_CSPI, 12,               5,   { .v = NULL                 }, -1879048055, },
  { SPR_CSPI, 11,               5,   { .v = NULL                 }, -1879048054, },
  { SPR_CSPI, 10,               5,   { .v = NULL                 }, -1879048053, },
  { SPR_CSPI, 9,                5,   { .v = NULL                 }, -1879048086, },
  { SPR_PPOS, 0,                10,  { .p1 = A_Look              }, -1879048051, },
  { SPR_PPOS, 1,                10,  { .p1 = A_Look              }, -1879048052, },
  { SPR_PPOS, 0,                2,   { .p1 = A_Chase             }, -1879048049, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 0,                2,   { .p1 = A_Chase             }, -1879048048, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 1,                2,   { .p1 = A_Chase             }, -1879048047, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 1,                2,   { .p1 = A_Chase             }, -1879048046, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 2,                2,   { .p1 = A_Chase             }, -1879048045, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 2,                2,   { .p1 = A_Chase             }, -1879048044, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 3,                2,   { .p1 = A_Chase             }, -1879048043, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 3,                2,   { .p1 = A_Chase             }, -1879048050, .flags = STATEF_SKILL5FAST },
  { SPR_PPOS, 4,                10,  { .p1 = A_FaceTarget        }, -1879048041, },
  { SPR_PPOS, 5,                2,   { .p1 = A_MonsterProjectile }, -1879048040, .flags = STATEF_SKILL5FAST, .args = { MT_PLASMA + 1 }, },
  { SPR_PPOS, 4,                4,   { .v = NULL                 }, -1879048039, .flags = STATEF_SKILL5FAST, },
  { SPR_PPOS, 5,                2,   { .p1 = A_MonsterProjectile }, -1879048038, .flags = STATEF_SKILL5FAST, .args = { MT_PLASMA + 1 }, },
  { SPR_PPOS, 4,                4,   { .v = NULL                 }, -1879048037, .flags = STATEF_SKILL5FAST, },
  { SPR_PPOS, 5,                2,   { .p1 = A_MonsterProjectile }, -1879048036, .flags = STATEF_SKILL5FAST, .args = { MT_PLASMA + 1 }, },
  { SPR_PPOS, 4,                4,   { .v = NULL                 }, -1879048050, .flags = STATEF_SKILL5FAST, },
  { SPR_PPOS, 6,                5,   { .v = NULL                 }, -1879048034, .flags = STATEF_SKILL5FAST, },
  { SPR_PPOS, 6,                5,   { .p1 = A_Pain              }, -1879048050, .flags = STATEF_SKILL5FAST, },
  { SPR_PPOS, 7,                0,   { .p1 = A_FaceTarget        }, -1879048032, },
  { SPR_PPOS, 7,                5,   { .p1 = A_SpawnObject       }, -1879048031, .args = { -1879048179, 11468800, 0, 0, 2621440, 131072 , 0 , 98304 }, },
  { SPR_PPOS, 8,                5,   { .p1 = A_Scream            }, -1879048030, },
  { SPR_PPOS, 9,                5,   { .p1 = A_Fall              }, -1879048029, },
  { SPR_PPOS, 10,               5,   { .v = NULL                 }, -1879048028, },
  { SPR_PPOS, 11,               5,   { .v = NULL                 }, -1879048027, },
  { SPR_PPOS, 12,               -1,  { .v = NULL                 }, S_NULL, },
  { SPR_PPOS, 13,               5,   { .v = NULL                 }, -1879048025, },
  { SPR_PPOS, 14,               5,   { .p1 = A_XScream           }, -1879048024, },
  { SPR_PPOS, 15,               5,   { .p1 = A_Fall              }, -1879048023, },
  { SPR_PPOS, 16,               0,   { .p1 = A_FaceTarget        }, -1879048022, },
  { SPR_PPOS, 16,               5,   { .p1 = A_SpawnObject       }, -1879048021, .args = { -1879048178, 11141120, 0, -524288, 2097152, 262144 , 0 , 131072 }, },
  { SPR_PPOS, 17,               5,   { .v = NULL                 }, -1879048020, },
  { SPR_PPOS, 18,               5,   { .v = NULL                 }, -1879048019, },
  { SPR_PPOS, 19,               5,   { .v = NULL                 }, -1879048018, },
  { SPR_PPOS, 20,               -1,  { .v = NULL                 }, S_NULL, },
  { SPR_PPOS, 12,               5,   { .v = NULL                 }, -1879048016, },
  { SPR_PPOS, 11,               5,   { .v = NULL                 }, -1879048015, },
  { SPR_PPOS, 10,               5,   { .v = NULL                 }, -1879048014, },
  { SPR_PPOS, 9,                5,   { .v = NULL                 }, -1879048013, },
  { SPR_PPOS, 8,                5,   { .v = NULL                 }, -1879048012, },
  { SPR_PPOS, 7,                5,   { .v = NULL                 }, -1879048050, },
  { SPR_PHED, 0,                3,   { .v = NULL                 }, -1879048010, },
  { SPR_PHED, 1,                3,   { .v = NULL                 }, -1879048009, },
  { SPR_PHED, 2,                3,   { .v = NULL                 }, -1879048008, },
  { SPR_PHED, 3,                3,   { .v = NULL                 }, -1879048007, },
  { SPR_PHED, 4,                3,   { .v = NULL                 }, -1879048006, },
  { SPR_PHED, 5,                3,   { .v = NULL                 }, -1879048005, },
  { SPR_PHED, 6,                3,   { .v = NULL                 }, -1879048004, },
  { SPR_PHED, 7,                3,   { .v = NULL                 }, -1879048003, },
  { SPR_PHED, 8,                3,   { .v = NULL                 }, -1879048011, },
  { SPR_PHED, 9,                -1,  { .v = NULL                 }, -1879048002, },
  { SPR_PPOS, 21,               -1,  { .v = NULL                 }, -1879048001, },
  { SPR_PPOS, 22,               5,   { .v = NULL                 }, -1879047999, },
  { SPR_PPOS, 23,               -1,  { .v = NULL                 }, S_NULL, },
  { SPR_VASS, 0,                10,  { .p1 = A_Look              }, -1879047997, },
  { SPR_VASS, 1,                10,  { .p1 = A_Look              }, -1879047998, },
  { SPR_VASS, 0,                3,   { .p1 = A_Chase             }, -1879047995, },
  { SPR_VASS, 0,                3,   { .p1 = A_Chase             }, -1879047994, },
  { SPR_VASS, 1,                3,   { .p1 = A_Chase             }, -1879047993, },
  { SPR_VASS, 1,                3,   { .p1 = A_Chase             }, -1879047992, },
  { SPR_VASS, 2,                3,   { .p1 = A_Chase             }, -1879047991, },
  { SPR_VASS, 2,                3,   { .p1 = A_Chase             }, -1879047990, },
  { SPR_VASS, 3,                3,   { .p1 = A_Chase             }, -1879047989, },
  { SPR_VASS, 3,                3,   { .p1 = A_Chase             }, -1879047996, },
  { SPR_VASS, 4|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047987, .misc1 = -1879048159, },
  { SPR_VASS, 4|FF_FULLBRIGHT,  8,   { .p1 = A_FaceTarget        }, -1879047986, },
  { SPR_VASS, 5|FF_FULLBRIGHT,  4,   { .p1 = A_FaceTarget        }, -1879047985, },
  { SPR_VASS, 6|FF_FULLBRIGHT,  4,   { .p1 = A_FaceTarget        }, -1879047984, },
  { SPR_VASS, 7|FF_FULLBRIGHT,  8,   { .p1 = A_MonsterProjectile }, -1879047996, .args = { -1879048177 }, },
  { SPR_VASS, 8,                2,   { .v = NULL                 }, -1879047982, },
  { SPR_VASS, 8,                2,   { .p1 = A_Pain              }, -1879047996, },
  { SPR_VASS, 9|FF_FULLBRIGHT,  8,   { .v = NULL                 }, -1879047980, },
  { SPR_VASS, 10|FF_FULLBRIGHT, 8,   { .p1 = A_Scream            }, -1879047979, },
  { SPR_VASS, 11|FF_FULLBRIGHT, 7,   { .v = NULL                 }, -1879047978, },
  { SPR_VASS, 12|FF_FULLBRIGHT, 6,   { .p1 = A_Fall              }, -1879047977, },
  { SPR_VASS, 13|FF_FULLBRIGHT, 6,   { .v = NULL                 }, -1879047976, },
  { SPR_VASS, 14|FF_FULLBRIGHT, 6,   { .v = NULL                 }, -1879047975, },
  { SPR_VASS, 15|FF_FULLBRIGHT, 7,   { .v = NULL                 }, -1879047974, },
  { SPR_VASS, 16,               -1,  { .p1 = A_BossDeath         }, S_NULL, },
  { SPR_VASS, 15,               8,   { .v = NULL                 }, -1879047972, },
  { SPR_VASS, 14,               8,   { .v = NULL                 }, -1879047971, },
  { SPR_VASS, 13,               8,   { .v = NULL                 }, -1879047970, },
  { SPR_VASS, 12,               8,   { .v = NULL                 }, -1879047969, },
  { SPR_VASS, 11,               8,   { .v = NULL                 }, -1879047968, },
  { SPR_VASS, 10,               8,   { .v = NULL                 }, -1879047967, },
  { SPR_VASS, 9,                8,   { .v = NULL                 }, -1879047996, },
  { SPR_VFLM, 0|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047965, },
  { SPR_VFLM, 1|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047966, },
  { SPR_VFLM, 2|FF_FULLBRIGHT,  0,   { .p1 = A_RemoveFlags       }, -1879047963, .args = { MF_NOGRAVITY }, },
  { SPR_VFLM, 2|FF_FULLBRIGHT,  0,   { .p1 = A_RemoveFlags       }, -1879047962, .args = { MF_NOBLOCKMAP }, },
  { SPR_VFLM, 2|FF_FULLBRIGHT,  0,   { .p1 = A_RandomJump        }, -1879047961, .misc1 = -1879047960, .misc2 = 128, },
  { SPR_VFLM, 2|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047959, .misc1 = -1879048171, },
  { SPR_VFLM, 2|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047959, .misc1 = -1879048170, },
  { SPR_VFLM, 2|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047958, .args = { 10 , 128 } },
  { SPR_VFLM, 3|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047957, },
  { SPR_VFLM, 4|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047956, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047955, .misc1 = -1879048169, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047954, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047953, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047952, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047951, .misc1 = -1879048170, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047950, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047949, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047948, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047947, .misc1 = -1879048169, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047946, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047945, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047944, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047943, .misc1 = -1879048171, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047942, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047941, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047940, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047939, .misc1 = -1879048170, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047938, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047937, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047936, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047935, .misc1 = -1879048171, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047934, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047933, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047932, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047931, .misc1 = -1879048170, },
  { SPR_VFLM, 5|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047930, .args = { 10, 128 } },
  { SPR_VFLM, 6|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047929, },
  { SPR_VFLM, 7|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047928, },
  { SPR_VFLM, 8|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047927, .misc1 = -1879048169, },
  { SPR_VFLM, 8|FF_FULLBRIGHT,  4,   { .p1 = A_RadiusDamage      }, -1879047926, .args = { 10, 128 } },
  { SPR_VFLM, 9|FF_FULLBRIGHT,  4,   { .v = NULL                 }, -1879047925, },
  { SPR_VFLM, 10|FF_FULLBRIGHT, 4,   { .v = NULL                 }, -1879047924, },
  { SPR_VFLM, 11|FF_FULLBRIGHT, 4,   { .p1 = A_RadiusDamage      }, -1879047923, .args = { 10, 128 } },
  { SPR_VFLM, 12|FF_FULLBRIGHT, 4,   { .v = NULL                 }, -1879047922, },
  { SPR_VFLM, 13|FF_FULLBRIGHT, 4,   { .v = NULL                 }, -1879047921, },
  { SPR_VFLM, 14|FF_FULLBRIGHT, 4,   { .v = NULL                 }, -1879047920, },
  { SPR_VFLM, 15|FF_FULLBRIGHT, 4,   { .v = NULL                 }, -1879047919, },
  { SPR_VFLM, 16|FF_FULLBRIGHT, 4,   { .v = NULL                 }, S_NULL, },
  { SPR_CHR1, 0,                10,  { .p1 = A_Look              }, -1879047917, },
  { SPR_CHR1, 1,                10,  { .p1 = A_Look              }, -1879047918, },
  { SPR_CHR1, 0,                3,   { .p1 = A_Hoof              }, -1879047915, },
  { SPR_CHR1, 0,                3,   { .p1 = A_Chase             }, -1879047914, },
  { SPR_CHR1, 1,                3,   { .p1 = A_Chase             }, -1879047913, },
  { SPR_CHR1, 1,                3,   { .p1 = A_Chase             }, -1879047912, },
  { SPR_CHR1, 2,                3,   { .p1 = A_Chase             }, -1879047911, },
  { SPR_CHR1, 2,                3,   { .p1 = A_Chase             }, -1879047910, },
  { SPR_CHR1, 3,                0,   { .p1 = A_PlaySound         }, -1879047909, .misc1 = -1879048161 },
  { SPR_CHR1, 3,                3,   { .p1 = A_Chase             }, -1879047908, },
  { SPR_CHR1, 3,                3,   { .p1 = A_Chase             }, -1879047916, },
  { SPR_CHR1, 4,                6,   { .p1 = A_FaceTarget        }, -1879047906, },
  { SPR_CHR1, 5|FF_FULLBRIGHT,  12,  { .p1 = A_CyberAttack       }, -1879047905, },
  { SPR_CHR1, 4,                12,  { .p1 = A_FaceTarget        }, -1879047904, },
  { SPR_CHR1, 5|FF_FULLBRIGHT,  12,  { .p1 = A_CyberAttack       }, -1879047903, },
  { SPR_CHR1, 4,                12,  { .p1 = A_FaceTarget        }, -1879047902, },
  { SPR_CHR1, 5|FF_FULLBRIGHT,  12,  { .p1 = A_CyberAttack       }, -1879047916, },
  { SPR_CHR1, 6,                10,  { .p1 = A_Pain              }, -1879047916, },
  { SPR_CHR1, 7,                10,  { .v = NULL                 }, -1879047899, },
  { SPR_CHR1, 8,                10,  { .p1 = A_Scream            }, -1879047898, },
  { SPR_CHR1, 9,                10,  { .v = NULL                 }, -1879047897, },
  { SPR_CHR1, 10,               10,  { .v = NULL                 }, -1879047896, },
  { SPR_CHR1, 11,               10,  { .v = NULL                 }, -1879047895, },
  { SPR_CHR1, 12,               10,  { .p1 = A_Fall              }, -1879047894, },
  { SPR_CHR1, 13,               10,  { .v = NULL                 }, -1879047893, },
  { SPR_CHR1, 14,               10,  { .v = NULL                 }, -1879047892, },
  { SPR_CHR1, 15,               30,  { .v = NULL                 }, -1879047891, },
  { SPR_CHR1, 15,               -1,  { .p1 = A_BossDeath         }, S_NULL, },
  { SPR_FLMG, 0,                1,   { .p2 = A_WeaponReady       }, -1879047890, },
  { SPR_FLMG, 0,                1,   { .p2 = A_Lower             }, -1879047889, },
  { SPR_FLMG, 0,                1,   { .p2 = A_Raise             }, -1879047888, },
  { SPR_FLMF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponJump        }, -1879047886, .args = { -1879047885, 128 }, },
  { SPR_FLMF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponSound       }, -1879047884, .args = { -1879048173 }, },
  { SPR_FLMF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponSound       }, -1879047884, .args = { -1879048172 }, },
  { SPR_FLMF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_GunFlash          }, -1879047883, },
  { SPR_FLMF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_ConsumeAmmo       }, -1879047882, .args = { 1 }, },
  { SPR_FLMF, 0|FF_FULLBRIGHT,  1,   { .p2 = A_WeaponProjectile  }, -1879047881, .args = { -1879048183 }, },
  { SPR_FLMF, 1|FF_FULLBRIGHT,  1,   { .v = NULL                 }, -1879047880, },
  { SPR_FLMG, 0,                1,   { .v = NULL                 }, -1879047879, },
  { SPR_FLMG, 0,                0,   { .p2 = A_ReFire            }, -1879047890, },
  { SPR_TNT1, 0,                2,   { .p2 = A_Light2            }, -1879047877, },
  { SPR_TNT1, 0,                1,   { .p2 = A_Light1            }, S_LIGHTDONE, },
  { SPR_TNT1, 0|FF_FULLBRIGHT,  1,   { .v = NULL                 }, -1879047875, },
  { SPR_IFLM, 0|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047874, },
  { SPR_IFLM, 1|FF_FULLBRIGHT,  2,   { .p1 = A_PlaySound         }, -1879047873, .misc1 = -1879048174, },
  { SPR_IFLM, 2|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047872, },
  { SPR_IFLM, 3|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047871, },
  { SPR_IFLM, 4|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047870, },
  { SPR_IFLM, 5|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047869, },
  { SPR_IFLM, 6|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047868, },
  { SPR_IFLM, 7|FF_FULLBRIGHT,  2,   { .v = NULL                 }, S_NULL, },
  { SPR_IFLM, 0|FF_FULLBRIGHT,  0,   { .p1 = A_RandomJump        }, -1879047866, .misc1 = -1879047865, .misc2 = 128, },
  { SPR_IFLM, 0|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047864, .misc1 = -1879048171, },
  { SPR_IFLM, 0|FF_FULLBRIGHT,  0,   { .p1 = A_PlaySound         }, -1879047864, .misc1 = -1879048170, },
  { SPR_IFLM, 8|FF_FULLBRIGHT,  2,   { .p1 = A_RadiusDamage      }, -1879047863, .args = { 5, 64 } },
  { SPR_IFLM, 9|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047862, },
  { SPR_IFLM, 8|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047861, },
  { SPR_IFLM, 9|FF_FULLBRIGHT,  2,   { .p1 = A_RadiusDamage      }, -1879047860, .args = { 5, 64 } },
  { SPR_IFLM, 10|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047859, },
  { SPR_IFLM, 9|FF_FULLBRIGHT,  2,   { .v = NULL                 }, -1879047858, },
  { SPR_IFLM, 10|FF_FULLBRIGHT, 2,   { .p1 = A_RadiusDamage      }, -1879047857, .args = { 5, 64 } },
  { SPR_IFLM, 11|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047856, },
  { SPR_IFLM, 10|FF_FULLBRIGHT, 2,   { .p1 = A_PlaySound         }, -1879047855, .misc1 = -1879048169, },
  { SPR_IFLM, 11|FF_FULLBRIGHT, 2,   { .p1 = A_RadiusDamage      }, -1879047854, .args = { 5, 64 } },
  { SPR_IFLM, 12|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047853, },
  { SPR_IFLM, 11|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047852, },
  { SPR_IFLM, 12|FF_FULLBRIGHT, 2,   { .p1 = A_RadiusDamage      }, -1879047851, .args = { 5, 64 } },
  { SPR_IFLM, 13|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047850, },
  { SPR_IFLM, 12|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047849, },
  { SPR_IFLM, 13|FF_FULLBRIGHT, 2,   { .p1 = A_RadiusDamage      }, -1879047848, .args = { 5, 64 } },
  { SPR_IFLM, 14|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047847, },
  { SPR_IFLM, 13|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047846, },
  { SPR_IFLM, 14|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047845, },
  { SPR_IFLM, 15|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047844, },
  { SPR_IFLM, 14|FF_FULLBRIGHT, 2,   { .v = NULL                 }, -1879047843, },
  { SPR_IFLM, 15|FF_FULLBRIGHT, 2,   { .v = NULL                 }, S_NULL, },
  { SPR_INCN, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_HETG, 0,                1,   { .p2 = A_WeaponReady       }, -1879047841, },
  { SPR_HETG, 0,                1,   { .p2 = A_Lower             }, -1879047840, },
  { SPR_HETG, 0,                1,   { .p2 = A_Raise             }, -1879047839, },
  { SPR_HETG, 0,                0,   { .p2 = A_ConsumeAmmo       }, -1879047837, },
  { SPR_HETG, 0,                0,   { .p2 = A_GunFlashTo        }, -1879047836, .args = { -1879047763, true } },
  { SPR_HETG, 0,                20,  { .p2 = A_WeaponSound       }, -1879047835, .args = { -1879048177 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_CheckAmmo         }, -1879047834, .args = { -1879047773 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_RefireTo          }, -1879047773, .args = { -1879047833 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_ConsumeAmmo       }, -1879047832, },
  { SPR_HETG, 0,                0,   { .p2 = A_GunFlashTo        }, -1879047831, .args = { -1879047759, true } },
  { SPR_HETG, 0,                20,  { .p2 = A_WeaponSound       }, -1879047830, .args = { -1879048177 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_CheckAmmo         }, -1879047829, .args = { -1879047779 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_RefireTo          }, -1879047779, .args = { -1879047828 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_ConsumeAmmo       }, -1879047827, },
  { SPR_HETG, 0,                0,   { .p2 = A_GunFlashTo        }, -1879047826, .args = { -1879047755, true } },
  { SPR_HETG, 0,                20,  { .p2 = A_WeaponSound       }, -1879047825, .args = { -1879048177 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_CheckAmmo         }, -1879047824, .args = { -1879047788 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_RefireTo          }, -1879047788, .args = { -1879047823 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_ConsumeAmmo       }, -1879047822, },
  { SPR_HETG, 0,                0,   { .p2 = A_GunFlashTo        }, -1879047821, .args = { -1879047751, true } },
  { SPR_HETG, 0,                20,  { .p2 = A_WeaponSound       }, -1879047820, .args = { -1879048177 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_CheckAmmo         }, -1879047819, .args = { -1879047800 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_RefireTo          }, -1879047800, .args = { -1879047818 }, },
  { SPR_HETG, 0,                0,   { .p2 = A_ConsumeAmmo       }, -1879047817, },
  { SPR_HETG, 0,                0,   { .p2 = A_GunFlashTo        }, -1879047816, .args = { -1879047747, true } },
  { SPR_HETG, 0,                20,  { .p2 = A_WeaponSound       }, -1879047815, .args = { -1879048177 }, },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047814, .args = { -1879048182, -2293760 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047813, .args = { -1879048182, -1966080 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047812, .args = { -1879048182, -1638400 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047811, .args = { -1879048182, -1310720 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047810, .args = { -1879048182, -983040 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047809, .args = { -1879048182, -655360 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047808, .args = { -1879048182, -327680 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047807, .args = { -1879048182 }, },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047806, .args = { -1879048182, 327680 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047805, .args = { -1879048182, 655360 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047804, .args = { -1879048182, 983040 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047803, .args = { -1879048182, 1310720 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047802, .args = { -1879048182, 1638400 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047801, .args = { -1879048182, 1966080 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047770, .args = { -1879048182, 2293760 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047799, .args = { -1879048182, -1802240 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047798, .args = { -1879048182, -1474560 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047797, .args = { -1879048182, -1146880 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047796, .args = { -1879048182, -819200 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047795, .args = { -1879048182, -491520 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047794, .args = { -1879048182, -163840 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047793, .args = { -1879048182, 163840 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047792, .args = { -1879048182, 491520 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047791, .args = { -1879048182, 819200 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047790, .args = { -1879048182, 1146880 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047789, .args = { -1879048182, 1474560 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047770, .args = { -1879048182, 1802240 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047787, .args = { -1879048182, -1310720 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047786, .args = { -1879048182, -983040 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047785, .args = { -1879048182, -655360 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047784, .args = { -1879048182, -327680 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047783, .args = { -1879048182 }, },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047782, .args = { -1879048182, 327680 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047781, .args = { -1879048182, 655360 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047780, .args = { -1879048182, 983040 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047770, .args = { -1879048182, 1310720 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047778, .args = { -1879048182, -819200 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047777, .args = { -1879048182, -491520 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047776, .args = { -1879048182, -163840 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047775, .args = { -1879048182, 163840 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047774, .args = { -1879048182, 491520 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047770, .args = { -1879048182, 819200 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047772, .args = { -1879048182, -327680 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047771, .args = { -1879048182 }, },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponProjectile  }, -1879047770, .args = { -1879048182, 327680 } },
  { SPR_HETF, 0|FF_FULLBRIGHT,  0,   { .p2 = A_WeaponSound       }, -1879047769, .args = { -1879048176 }, },
  { SPR_HETF, 0|FF_FULLBRIGHT,  3,   { .p2 = A_GunFlash          }, -1879047768, },
  { SPR_HETF, 1|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879047767, },
  { SPR_HETC, 0|FF_FULLBRIGHT,  6,   { .v = NULL                 }, -1879047762, },
  { SPR_HETC, 1|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879047761, },
  { SPR_HETC, 2|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879047760, },
  { SPR_HETC, 3|FF_FULLBRIGHT,  5,   { .v = NULL                 }, S_LIGHTDONE, },
  { SPR_HETC, 4|FF_FULLBRIGHT,  6,   { .v = NULL                 }, -1879047758, },
  { SPR_HETC, 5|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879047757, },
  { SPR_HETC, 6|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879047756, },
  { SPR_HETC, 7|FF_FULLBRIGHT,  5,   { .v = NULL                 }, S_LIGHTDONE, },
  { SPR_HETC, 8|FF_FULLBRIGHT,  6,   { .v = NULL                 }, -1879047754, },
  { SPR_HETC, 9|FF_FULLBRIGHT,  5,   { .v = NULL                 }, -1879047753, },
  { SPR_HETC, 10|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879047752, },
  { SPR_HETC, 11|FF_FULLBRIGHT, 5,   { .v = NULL                 }, S_LIGHTDONE, },
  { SPR_HETC, 12|FF_FULLBRIGHT, 6,   { .v = NULL                 }, -1879047750, },
  { SPR_HETC, 13|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879047749, },
  { SPR_HETC, 14|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879047748, },
  { SPR_HETC, 15|FF_FULLBRIGHT, 5,   { .v = NULL                 }, S_LIGHTDONE, },
  { SPR_HETC, 16|FF_FULLBRIGHT, 6,   { .v = NULL                 }, -1879047746, },
  { SPR_HETC, 17|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879047745, },
  { SPR_HETC, 18|FF_FULLBRIGHT, 5,   { .v = NULL                 }, -1879047744, },
  { SPR_HETC, 19|FF_FULLBRIGHT, 5,   { .v = NULL                 }, S_LIGHTDONE, },
  { SPR_TNT1, 0,                3,   { .p2 = A_Light1            }, -1879047742, },
  { SPR_TNT1, 0,                5,   { .p2 = A_Light2            }, S_LIGHTDONE, },
  { SPR_TNT1, 0,                0,   { .v = NULL                 }, -1879047740, },
  { SPR_TNT1, 0,                1,   { .p1 = A_SpawnObject       }, S_NULL, .args =  { -1879048181, 0, 0, 0, 0, 1310720 }, },
  { SPR_HETF, 0|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047738, },
  { SPR_HETF, 1|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047737, },
  { SPR_HETF, 2|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047739, },
  { SPR_HETF, 3|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047735, },
  { SPR_HETF, 4|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047734, },
  { SPR_HETF, 5|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047733, },
  { SPR_HETF, 6|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047732, },
  { SPR_HETF, 7|FF_FULLBRIGHT,  3,   { .v = NULL                 }, -1879047731, },
  { SPR_HETF, 8|FF_FULLBRIGHT,  3,   { .v = NULL                 }, S_NULL, },
  { SPR_CBLD, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_FCPU, 0,                -1,  { .v = NULL                 }, S_NULL, },
  { SPR_FTNK, 0,                -1,  { .v = NULL                 }, S_NULL, },
};
...
mobjinfo_t id24_mobjinfo[NUMMOBJTYPES_ID24] = {
    {
        // Ghoul
        .doomednum = -28672,
        .spawnstate = -1879048150,
        .spawnhealth = 50,
        .seestate = -1879048148,
        .seesound = -1879048178,
        .reactiontime = 8,
        .attacksound = sfx_None,
        .painstate = -1879048136,
        .painchance = 128,
        .painsound = -1879048179,
        .meleestate = S_NULL,
        .missilestate = -1879048140,
        .deathstate = -1879048134,
        .xdeathstate = S_NULL,
        .deathsound = -1879048180,
        .speed = 12,
        .radius = 1048576,
        .height = 2621440,
        .mass = 50,
        .damage = 0,
        .activesound = -1879048181,
        .flags = 4211206,
        .raisestate = S_NULL,
        // DEHEXTRA
        .droppeditem = MT_NULL,
...

    {
        // Banshee
        .doomednum = -28671,
        .spawnstate = -1879048119,
        .spawnhealth = 100,
        .seestate = -1879048117,
        .seesound = -1879048192,
        .reactiontime = 8,
        .attacksound = sfx_None,
        .painstate = -1879048097,
        .painchance = 64,
        .painsound = -1879048190,
        .meleestate = -1879048098,
        .missilestate = S_NULL,
        .deathstate = -1879048095,
        .xdeathstate = S_NULL,
        .deathsound = -1879048191,
        .speed = 8,
        .radius = 1310720,
        .height = 3670016,
        .mass = 500,
...

    {
        // Mindweaver
        .doomednum = -28670,
        .spawnstate = -1879048089,
        .spawnhealth = 500,
        .seestate = -1879048087,
        .seesound = -1879048186,
        .reactiontime = 8,
        .attacksound = sfx_None,
        .painstate = -1879048068,
        .painchance = 40,
        .painsound = sfx_dmpain,
        .meleestate = S_NULL,
        .missilestate = -1879048072,
        .deathstate = -1879048066,
        .xdeathstate = S_NULL,
        .deathsound = -1879048187,
        .speed = 12,
        .radius = 4194304,
        .height = 4194304,
        .mass = 600,
        .damage = 0,
        .activesound = -1879048188,
        .flags = 4194310,
        .raisestate = -1879048059,
        // DEHEXTRA
        .droppeditem = MT_NULL,
        // MBF21
        .flags2 = MF2_NONE,
...

    {
        // Shocktrooper
        .doomednum = -28669,
        .spawnstate = -1879048052,
        .spawnhealth = 100,
        .seestate = -1879048050,
        .seesound = sfx_None,
        .reactiontime = 8,
        .attacksound = sfx_None,
        .painstate = -1879048035,
        .painchance = 30,
        .painsound = -1879048164,
        .meleestate = S_NULL,
        .missilestate = -1879048042,
        .deathstate = -1879048033,
        .xdeathstate = -1879048026,
        .deathsound = -1879048166,
        .speed = 10,
        .radius = 1310720,
        .height = 3670016,
        .mass = 100,
        .damage = 0,
        .activesound = -1879048167,
        .flags = 4194310,
        .raisestate = -1879048017,
        // DEHEXTRA
        .droppeditem = MT_NULL,
        // MBF21
        .flags2 = MF2_NONE,
...

    {
        // Vassago
        .doomednum = -28668,
        .spawnstate = -1879047998,
        .spawnhealth = 1000,
        .seestate = -1879047996,
        .seesound = -1879048156,
        .reactiontime = 8,
        .attacksound = sfx_None,
        .painstate = -1879047983,
        .painchance = 100,
        .painsound = -1879048157,
        .meleestate = -1879047988,
        .missilestate = -1879047988,
        .deathstate = -1879047981,
        .xdeathstate = S_NULL,
        .deathsound = -1879048158,
        .speed = 8,
        .radius = 1572864,
        .height = 4194304,
        .mass = 1000,
        .damage = 0,
        .activesound = -1879048160,
        .flags = 4194310,
        .raisestate = -1879047973,
        // DEHEXTRA
        .droppeditem = MT_NULL,
        // MBF21
        .flags2 = MF2_NONE,
...

    {
        // Tyrant
        .doomednum = -28667,
        .spawnstate = -1879047918,
        .spawnhealth = 1000,
        .seestate = -1879047916,
        .seesound = -1879048162,
        .reactiontime = 8,
        .attacksound = sfx_None,
        .painstate = -1879047901,
        .painchance = 20,
        .painsound = sfx_dmpain,
        .meleestate = S_NULL,
        .missilestate = -1879047907,
        .deathstate = -1879047900,
        .xdeathstate = S_NULL,
        .deathsound = -1879048163,
        .speed = 16,
        .radius = 2621440,
        .height = 7208960,
        .mass = 1000,
        ...
        .flags2 = 303720,
        .infighting_group = IG_DEFAULT,
        .projectile_group = PG_TYRANT,
        .splash_group = SG_TYRANT,
        .ripsound = sfx_None,
        .altspeed = NO_ALTSPEED,
        .meleerange = 4194304,
        // ID24
...

    {
        ...
        .meleestate = S_NULL,
        .missilestate = S_NULL,
        .deathstate = -1879047740,
        .xdeathstate = S_NULL,
        .deathsound = -1879048175,
        .speed = 0,
        .radius = 1048576,
        .height = 524288,
        .mass = 0,
...

    {
        ...
        .meleestate = S_NULL,
        .missilestate = S_NULL,
        .deathstate = -1879048002,
        .xdeathstate = S_NULL,
        .deathsound = -1879048165,
        .speed = 524288,
        .radius = 393216,
        .height = 1048576,
        .mass = 0,
    ...
    {
        // Hanging victim, both legs
        .doomednum = -28660,
        .spawnstate = -1879048185,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Hanging victim, both legs (blocking)
        .doomednum = -28659,
        .spawnstate = -1879048185,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Hanging victim, crucified
        .doomednum = -28658,
        .spawnstate = -1879048184,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Hanging victim, crucified (blocking)
        .doomednum = -28657,
        .spawnstate = -1879048184,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Hanging victim, arms bound
        .doomednum = -28656,
        .spawnstate = -1879048183,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Hanging victim, arms bound (blocking)
        .doomednum = -28655,
        .spawnstate = -1879048183,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Hanging baron of hell
        .doomednum = -28654,
        .spawnstate = -1879048182,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Hanging baron of hell (blocking)
        .doomednum = -28653,
        .spawnstate = -1879048182,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Hanging victim, chained
        .doomednum = -28652,
        .spawnstate = -1879048181,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Hanging victim, chained (blocking)
        .doomednum = -28651,
        .spawnstate = -1879048181,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Hanging torso, chained
        .doomednum = -28650,
        .spawnstate = -1879048180,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Hanging torso, chained (blocking)
        .doomednum = -28649,
        .spawnstate = -1879048180,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Cave stalagmite, large
        .doomednum = -28639,
        .spawnstate = -1879048169,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Cave stalagmite, medium
        .doomednum = -28638,
        .spawnstate = -1879048168,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Cave stalagmite, small
        .doomednum = -28637,
        .spawnstate = -1879048167,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Cave stalactite, large
        .doomednum = -28636,
        .spawnstate = -1879048166,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Cave stalactite, large (blocking)
        .doomednum = -28635,
        .spawnstate = -1879048166,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Cave stalactite, medium
        .doomednum = -28634,
        .spawnstate = -1879048165,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Cave stalactite, medium (blocking)
        .doomednum = -28633,
        .spawnstate = -1879048165,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Cave stalactite, small
        .doomednum = -28632,
        .spawnstate = -1879048164,
        .spawnhealth = 0,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
    ...
    {
        // Cave stalactite, small (blocking)
        .doomednum = -28631,
        .spawnstate = -1879048164,
        .spawnhealth = 0,
        .seestate = S_NULL,
    ...
    {
        // Office lamp (breakable)
        .doomednum = -28629,
        .spawnstate = -1879048162,
        .spawnhealth = 20,
        .seestate = S_NULL,
        .seesound = sfx_None,
        .reactiontime = 0,
        ...
        .meleestate = S_NULL,
        .missilestate = S_NULL,
        .deathstate = -1879048161,
        .xdeathstate = S_NULL,
        .deathsound = -1879048189,
        .speed = 0,
        .radius = 786432,
        .height = 3407872,
        .mass = 65536,
...

    {
        ...
        .respawn_min_tics = RESPAWN_TICS,
        .respawn_dice = RESPAWN_DICE,
        .pickup_ammo_type = am_fuel,
        .pickup_ammo_category = 0,
        .pickup_weapon_type = NO_INDEX,
        .pickup_item_type = NO_INDEX,
        .pickup_bonus = PICKUP_BONUS,
        .pickup_sound = sfx_None,
        .pickup_mnemonic = "ID24_GOTFUELCAN",
        .xlat_lump = NULL,
    },

    {
        ...
        .pickup_bonus = PICKUP_BONUS,
        .pickup_sound = sfx_None,
        .pickup_mnemonic = "ID24_GOTFUELTANK",
        .xlat_lump = NULL,
    },

    {
        ...
        .pickup_ammo_type = NO_INDEX,
        .pickup_ammo_category = NO_INDEX,
        .pickup_weapon_type = wp_calamityblade,
        .pickup_item_type = NO_INDEX,
        .pickup_bonus = PICKUP_BONUS,
        .pickup_sound = sfx_wpnup,
        .pickup_mnemonic = "ID24_GOTCALAMITYBLADE",
        .xlat_lump = NULL,
    },

    {
        ...
        .pickup_ammo_type = NO_INDEX,
        .pickup_ammo_category = NO_INDEX,
        .pickup_weapon_type = wp_incinerator,
        .pickup_item_type = NO_INDEX,
        .pickup_bonus = PICKUP_BONUS,
        .pickup_sound = sfx_wpnup,
        .pickup_mnemonic = "ID24_GOTINCINERATOR",
        .xlat_lump = NULL,
    },
};
